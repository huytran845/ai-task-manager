  ...
  return (
    <>
      <div className="relative isolate min-h-[100dvh] flex flex-col overflow-hidden">
        ...
        <div className="bg-primary/20 absolute bottom-20 right-0 w-80 h-10 rotate-45 origin-bottom-right blur-3xl"></div>

        {/* Loader */}
        {isLoading && (
          <div className="fixed top-0 left-0 z-50 w-full h-[100vh] bg-background flex flex-col justify-center items-center gap-5">
            <img
              src={logo}
              width={64}
              height={64}
